                            ...
                            <div class="content-product-left col-sm-7 col-xs-12">
                                <div id="thumb-slider-vertical" class="thumb-vertical-outer">
                                    ...
                                    <ul class="thumb-vertical">
                                        <li class="owl2-item">
                                            <a data-index="0" class="img thumbnail" data-image="{{ asset('') }}frontend/assets/image/demo/shop/product/J9.jpg" title="Canon EOS 5D">
                                                <img src="{{ asset('') }}frontend/assets/image/demo/shop/product/J9.jpg" title="Canon EOS 5D" alt="Canon EOS 5D" />
                                            </a>
                                        </li>
                                        <li class="owl2-item">
                                            <a data-index="1" class="img thumbnail" data-image="{{ asset('') }}frontend/assets/image/demo/shop/product/J6.jpg" title="Bint Beef">
                                                <img src="{{ asset('') }}frontend/assets/image/demo/shop/product/J6.jpg" title="Bint Beef" alt="Bint Beef" />
                                            </a>
                                        </li>
                                        <li class="owl2-item">
                                            <a data-index="2" class="img thumbnail" data-image="{{ asset('') }}frontend/assets/image/demo/shop/product/J5.jpg" title="Bint Beef">
                                                <img src="{{ asset('') }}frontend/assets/image/demo/shop/product/J5.jpg" title="Bint Beef" alt="Bint Beef" />
                                            </a>
                                        </li>
                                        <li class="owl2-item">
                                            <a data-index="3" class="img thumbnail" data-image="{{ asset('') }}frontend/assets/image/demo/shop/product/J4.jpg" title="Bint Beef">
                                                <img src="{{ asset('') }}frontend/assets/image/demo/shop/product/J4.jpg" title="Bint Beef" alt="Bint Beef" />
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="large-image vertical">
                                    <img
                                        ...
                                        src="{{ asset('') }}frontend/assets/image/demo/shop/product/J9.jpg"
                                        data-zoom-image="{{ asset('') }}frontend/assets/image/demo/shop/product/J9.jpg"
                                        title="Bint Beef"
                                        alt="Bint Beef"
                                    />
                                </div>
                                        ...
                                        <ul class="product-options clearfix" id="input-option231">
                                            <li class="radio active">
                                                <label>
                                                    ...
                                                    <img src="{{ asset('') }}frontend/assets/image/demo/colors/blue.jpg" data-original-title="blue +$12.00" class="img-thumbnail icon icon-color" /> <i class="fa fa-check"></i>
                                                    <label> </label>
                                                </label>
                                            </li>
                                            <li class="radio">
                                                <label>
                                                    ...
                                                    <img src="{{ asset('') }}frontend/assets/image/demo/colors/brown.jpg" data-original-title="brown -$12.00" class="img-thumbnail icon icon-color" /> <i class="fa fa-check"></i>
                                                    <label> </label>
                                                </label>
                                            </li>
                                            <li class="radio">
                                                <label>
                                                    ...
                                                    <img src="{{ asset('') }}frontend/assets/image/demo/colors/green.jpg" data-original-title="green +$12.00" class="img-thumbnail icon icon-color" /> <i class="fa fa-check"></i>
                                                    <label> </label>
                                                </label>
                                            </li>
                                    ...
                                    <div class="form-group box-info-product">
                                        ...
                                        <div class="add-to-links wish_comp">
                                            <ul class="blank list-inline">
                                                <li class="wishlist">
                                                    <a class="icon" data-toggle="tooltip" title="" onclick="wishlist.add('50');" data-original-title="Add to Wish List"><i class="fa fa-heart"></i> </a>
                                                </li>
                                                <li class="compare">
                                                    <a class="icon" data-toggle="tooltip" title="" onclick="compare.add('50');" data-original-title="Compare this Product"><i class="fa fa-exchange"></i> </a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="policy-detail">
                                    <div class="banner-policy">
                                        <div class="policy policy1">
                                            <a href="#">
                                                <span class="ico-policy">&nbsp;</span> 90 day <br />
                                                money back
                                            </a>
                                        </div>
                    ...
                    <div class="tabsslider col-xs-12">
                        ...
                        <div class="tab-content col-xs-12">
                            <div id="tab-1" class="tab-pane fade active in">
                                <p>
                                    The 30-inch Apple Cinema HD Display delivers an amazing 2560 x 1600 pixel resolution. Designed specifically for the creative professional, this display provides more space for easier access to all the tools
                                    and palettes needed to edit, format and composite your work. Combine this display with a Mac Pro, MacBook Pro, or PowerMac G5 and there's no limit to what you can achieve. <br />
                                    <br />
                                    ...
                                    Unlike other flat panels, it's designed with a pure digital interface to deliver distortion-free images that never need adjusting. With over 4 million digital pixels, the display is uniquely suited for
                                    scientific and technical applications such as visualizing molecular structures or analyzing geological data. <br />
                                    <br />
                                    Offering accurate, brilliant color performance, the Cinema HD delivers up to 16.7 million colors across a wide gamut allowing you to see subtle nuances between colors from soft pastels to rich jewel tones. A
                                    wide viewing angle ensures uniform color from edge to edge. Apple's ColorSync technology allows you to create custom profiles to maintain consistent color onscreen and in print. The result: You can
                                    confidently use this display in all your color-critical applications. <br />
                                    <br />
                                    Housed in a new aluminum design, the display has a very thin bezel that enhances visual accuracy. Each display features two FireWire 400 ports and two USB 2.0 ports, making attachment of desktop peripherals,
                                    such as iSight, iPod, digital and still cameras, hard drives, printers and scanners, even more accessible and convenient. Taking advantage of the much thinner and lighter footprint of an LCD, the new displays
                                    support the VESA (Video Electronics Standards Association) mounting interface standard. Customers with the optional Cinema Display VESA Mount Adapter kit gain the flexibility to mount their display in
                                    locations most appropriate for their work environment. <br />
                                    <br />
                                    The Cinema HD features a single cable design with elegant breakout for the USB 2.0, FireWire 400 and a pure digital connection using the industry standard Digital Video Interface (DVI) interface. The DVI
                            ...
                            <div id="tab-review" class="tab-pane fade">
                                <form>
                                    ...
                                    <div class="contacts-form">
                                        ...
                                        <div class="form-group">
                                            <b>Rating</b> <span>Bad</span>&nbsp; <input type="radio" name="rating" value="1" /> &nbsp; <input type="radio" name="rating" value="2" /> &nbsp; <input type="radio" name="rating" value="3" /> &nbsp;
                                            <input type="radio" name="rating" value="4" /> &nbsp; <input type="radio" name="rating" value="5" /> &nbsp;<span>Good</span>
                                        </div>
                    ...
                    <div class="releate-products">
                            ...
                            <div class="product-item-container">
                                <div class="left-block">
                                    <div class="product-image-container second_img">
                                        <img src="{{ asset('') }}frontend/assets/image/demo/shop/product/e11.jpg" title='Apple Cinema 30"' class="img-responsive" />
                                        <img src="{{ asset('') }}frontend/assets/image/demo/shop/product/e12.jpg" title='Apple Cinema 30"' class="img_0 img-responsive" />
                                    </div>
                                    <!--Sale Label-->
                        ...
                        <div class="product-layout">
                            <div class="product-item-container">
                                <div class="left-block">
                                    <div class="product-image-container second_img">
                                        <img src="{{ asset('') }}frontend/assets/image/demo/shop/product/11.jpg" title='Apple Cinema 30"' class="img-responsive" />
                                        <img src="{{ asset('') }}frontend/assets/image/demo/shop/product/10.jpg" title='Apple Cinema 30"' class="img_0 img-responsive" />
                                    </div>
                                    <!--Sale Label-->
                                    <span class="label label-sale">Sale</span>
                                    <!--full quick view block-->
                        ...
                        <div class="product-layout">
                            <div class="product-item-container">
                                <div class="left-block">
                                    <div class="product-image-container second_img">
                                        <img src="{{ asset('') }}frontend/assets/image/demo/shop/product/35.jpg" title='Apple Cinema 30"' class="img-responsive" />
                                        <img src="{{ asset('') }}frontend/assets/image/demo/shop/product/34.jpg" title='Apple Cinema 30"' class="img_0 img-responsive" />
                                    </div>
                                    <!--Sale Label-->
                                    <span class="label label-sale">Sale</span>
                                    <!--full quick view block-->
                        ...
                        <div class="product-layout">
                            <div class="product-item-container">
                                <div class="left-block">
                                    <div class="product-image-container second_img">
                                        <img src="{{ asset('') }}frontend/assets/image/demo/shop/product/14.jpg" title='Apple Cinema 30"' class="img-responsive" />
                                        <img src="{{ asset('') }}frontend/assets/image/demo/shop/product/15.jpg" title='Apple Cinema 30"' class="img_0 img-responsive" />
                                    </div>
                                    <!--Sale Label-->
                                    <span class="label label-sale">Sale</span>
                                    <!--full quick view block-->
                ...
                <script type="text/javascript">
                    $(document).ready(function () {
                        ...
                        $(".large-image").magnificPopup({
                            items: [{ src: "image/demo/shop/product/J9.jpg" }, { src: "image/demo/shop/product/J6.jpg" }, { src: "image/demo/shop/product/J5.jpg" }, { src: "image/demo/shop/product/J4.jpg" }],
