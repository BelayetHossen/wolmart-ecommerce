            ...
            <div class="row">
                <div class="header-top-left form-inline col-lg-6 col-md-5 col-sm-6 compact-hidden hidden-sm ">
                    <div class="form-group navbar-welcome ">
                        Welcome to market <a href="register.html"><strong>Join Free</strong></a> or <a
                            href="login.html"><strong>Sign in</strong></a>
                    </div>
                </div>
                <div
                    ...
                    <div class="tabBlock" id="TabBlock-1">
                        <ul class="top-link list-inline">
                            ...
                            <li class="wishlist"><a href="wishlist.html" id="wishlist-total"
                                    class="top-link-wishlist" title="Wish List (2)"><span class="hidden-xs">Wish
                                        List (2)</span></a></li>
                            <li class="checkout"><a href="checkout.html" class="top-link-checkout"
                                    title="Checkout"><span class="hidden-xs">Checkout</span></a></li>
                        </ul>
                        <div class="form-group languages-block ">
                            <form action="https://demo.smartaddons.com/templates/html/market/index.html"
                                method="post" enctype="multipart/form-data" id="bt-language">
                                <a class="btn btn-xs dropdown-toggle" data-toggle="dropdown">
                                    <img src="{{ asset('') }}frontend/assets/image/demo/flags/gb.png" alt="English" title="English">
                                    <span class="hidden-xs">English</span>
                                    <span class="fa fa-angle-down"></span>
                                </a>
                                <ul class="dropdown-menu">
                                    <li><a href="#"><img class="image_flag" src="{{ asset('') }}frontend/assets/image/demo/flags/gb.png"
                                                alt="English" title="English" /> English </a></li>
                                    <li> <a href="#"> <img class="image_flag" src="{{ asset('') }}frontend/assets/image/demo/flags/lb.png"
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="navbar-logo col-md-3 col-sm-12 col-xs-12">
                    <a href="index.html"><img src="{{ asset('') }}frontend/assets/image/demo/logos/theme_logo.png" title="Your Store"
                            alt="Your Store" /></a>
                </div>
                <!-- //end Logo -->
                <!-- Main Menu -->
                <div class="phone-contact col-lg-offset-5 col-lg-2 col-md-offset-4 col-md-3 col-sm-9 hidden-xs">
                    <div class="inner-info">
                        <strong>Call us to free:</strong><br>
                        <span>Toll free: 1234567890</span>
                    </div>
                </div>
                <!-- //Main Menu -->
                <!-- Secondary menu -->
                                ...
                                <table class="table table-striped">
                                    <tbody>
                                        <tr>
                                            <td class="text-center" style="width:70px">
                                                <a href="product.html"> <img
                                                        src="{{ asset('') }}frontend/assets/image/demo/shop/product/resize/2.jpg"
                                        ...
                                        <tr>
                                            <td class="text-center" style="width:70px">
                                                <a href="product.html"> <img
                                                        src="{{ asset('') }}frontend/assets/image/demo/shop/product/resize/3.jpg"
        ...
        <div class="container">
            <div class="row">
                                            ...
                                            <ul class="megamenu " data-transition="slide"
                                                            ...
                                                            <div class="row">
                                                                    ...
                                                                    <a href="index.html" class="image-link">
                                                                        <span class="thumbnail">
                                                                            <img class="img-responsive img-border"
                                                                                src="{{ asset('') }}frontend/assets/image/demo/feature/home-1.jpg"
                                                                                alt="">
                                                                ...
                                                                <div class="col-md-15">
                                                                    <a href="home2.html" class="image-link">
                                                                        <span class="thumbnail">
                                                                            <img class="img-responsive img-border"
                                                                                src="{{ asset('') }}frontend/assets/image/demo/feature/home-2.jpg"
                                                                                alt="">
                                                                            <span class="btn btn-default">Read
                                                                                More</span>
                                                                        </span>
                                                                ...
                                                                <div class="col-md-15">
                                                                    <a href="home3.html" class="image-link">
                                                                        <span class="thumbnail">
                                                                            <img class="img-responsive img-border"
                                                                                src="{{ asset('') }}frontend/assets/image/demo/feature/home-3.jpg"
                                                                                alt="">
                                                                            <span class="btn btn-default">Read
                                                                                More</span>
                                                                        </span>
                                                                ...
                                                                <div class="col-md-15">
                                                                    <a href="home4.html" class="image-link">
                                                                        <span class="thumbnail">
                                                                            <img class="img-responsive img-border"
                                                                                src="{{ asset('') }}frontend/assets/image/demo/feature/home-4.jpg"
                                                                                alt="">
                                                                            <span class="btn btn-default">Read
                                                                                More</span>
                                                                        </span>
                                                                ...
                                                                <div class="col-md-15">
                                                                    <a href="home5.html" class="image-link">
                                                                        <span class="thumbnail">
                                                                            <img class="img-responsive img-border"
                                                                                src="{{ asset('') }}frontend/assets/image/demo/feature/home-5.jpg"
                                                                                alt="">
                                                                            <span class="btn btn-default">Read
                                                                                More</span>
                                                                        </span>
                                                                ...
                                                                <div class="col-md-15">
                                                                    <a href="home6.html" class="image-link">
                                                                        <span class="thumbnail">
                                                                            <img class="img-responsive img-border"
                                                                                src="{{ asset('') }}frontend/assets/image/demo/feature/home-6.jpg"
                                                                                alt="">
                                                                            <span class="btn btn-default">Read
                                                                                More</span>
                                                                        </span>
                                                                ...
                                                                <div class="col-md-15">
                                                                    <a href="home7.html" class="image-link">
                                                                        <span class="thumbnail">
                                                                            <img class="img-responsive img-border"
                                                                                src="{{ asset('') }}frontend/assets/image/demo/feature/home-7.jpg"
                                                                                alt="">
                                                                            <span class="btn btn-default">Read
                                                                                More</span>
                                                                        </span>
                                                                ...
                                                                <div class="col-md-15">
                                                                    <a href="home8.html" class="image-link">
                                                                        <span class="thumbnail">
                                                                            <img class="img-responsive img-border"
                                                                                src="{{ asset('') }}frontend/assets/image/demo/feature/home-8.jpg"
                                                                                alt="">
                                                                            <span class="btn btn-default">Read
                                                                                More</span>
                                                                        </span>
                                                                ...
                                                                <div class="col-md-15">
                                                                    <a href="html_width_RTL/index.html"
                                                                        class="image-link">
                                                                        <span class="thumbnail">
                                                                            <img class="img-responsive img-border"
                                                                                src="{{ asset('') }}frontend/assets/image/demo/feature/home-rtl.jpg"
                                                                                alt="">
                                                                            <span class="btn btn-default">Read
                                                                                More</span>
                                                                        </span>
                                                                ...
                                                                <div class="col-md-15">
                                                                    <a href="#" class="image-link">
                                                                        <span class="thumbnail">
                                                                            <img class="img-responsive img-border"
                                                                                src="{{ asset('') }}frontend/assets/image/demo/feature/comming-soon.png"
                                                                                alt="">
                                                                        </span>
                                                ...
                                                <li class="with-sub-menu hover">
                                                    ...
                                                    <a href="#" class="clearfix">
                                                        ...
                                                        <img class="label-hot"
                                                            src="{{ asset('') }}frontend/assets/image/theme/icons/hot-icon.png"
                                                            alt="icon items">
                                                        <b class="caret"></b>
                                                    </a>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="column">
                                                                        ...
                                                                        <div>
                                                                            <ul class="row-list">
                                                                                <li><a href="product.html">Image
                                                                                        size - big</a></li>
                                                                                <li><a href="product-v2.html">Image
                                                                                        size - medium</a></li>
                                                                                <li><a href="product-v3.html">Image
                                                                                        size - small</a></li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="row">
                                                                        <div class="col-md-3 img img1">
                                                                            <a href="#"><img
                                                                                    src="{{ asset('') }}frontend/assets/image/demo/cms/img1.jpg"
                                                                                    alt="banner1"></a>
                                                                        </div>
                                                                        <div class="col-md-3 img img2">
                                                                            <a href="#"><img
                                                                                    src="{{ asset('') }}frontend/assets/image/demo/cms/img2.jpg"
                                                                                    alt="banner2"></a>
                                                                        </div>
                                                                        <div class="col-md-3 img img3">
                                                                            <a href="#"><img
                                                                                    src="{{ asset('') }}frontend/assets/image/demo/cms/img3.jpg"
                                                                                    alt="banner3"></a>
                                                                        </div>
                                                                        <div class="col-md-3 img img4">
                                                                            <a href="#"><img
                                                                                    src="{{ asset('') }}frontend/assets/image/demo/cms/img4.jpg"
                                                                                    alt="banner4"></a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <div class="col-sm-12 list-product">
                                                                        <div class="product-thumb">
                                                                            <div class="image pull-left">
                                                                                <a href="#"><img
                                                                                        src="{{ asset('') }}frontend/assets/image/demo/shop/product/35.jpg"
                                                                                        width="80"
                                                                                        alt="Filet Mign"
                                                                                        title="Filet Mign"
                                                                    ...
                                                                    <div class="col-sm-12 list-product">
                                                                        <div class="product-thumb">
                                                                            <div class="image pull-left">
                                                                                <a href="#"><img
                                                                                        src="{{ asset('') }}frontend/assets/image/demo/shop/product/W1.jpg"
                                                                                        width="80"
                                                                                        alt="Dail Lulpa"
                                                                                        title="Dail Lulpa"
                                                                                        class="img-responsive"></a>
                                                                    ...
                                                                    <div class="col-sm-12 list-product">
                                                                        <div class="product-thumb">
                                                                            <div class="image pull-left">
                                                                                <a href="#"><img
                                                                                        src="{{ asset('') }}frontend/assets/image/demo/shop/product/141.jpg"
                                                                                        width="80"
                                                                                        alt="Canon EOS 5D"
                                                                                        title="Canon EOS 5D"
                                                                                        class="img-responsive"></a>
                ...
                <div class="header-bottom-right  collapsed-block col-md-4 col-sm-8 col-xs-6 ">
                    <h5 class="tabBlockTitle visible-xs"><i class="fa fa-search"></i> Search <a
                            class="expander " href="#sosearchpro"><i class="fa fa-angle-down"></i></a></h5>
                    <div id="sosearchpro" class="col-sm-7 search-pro tabBlock">
                        <form method="GET"
                            action="https://demo.smartaddons.com/templates/html/market/index.html">
                                            ...
                                            <div class="container">
                                                <ul class="megamenu">
                                                    ...
                                                    <li class="item-vertical with-sub-menu hover">
                                                        ...
                                                        <div class="sub-menu" data-subwidth="60" style="width: 540px; display: none;">
                                                            <div class="content" style="display: none;">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="row">
                        ...
                        <div class="container">
                            <ul class="megamenu " data-transition="slide" data-animationtime="250">
                                ...
                                <li class="with-sub-menu hover">
                                    ...
                                    <div class="sub-menu" style="width: 40%; display: none;">
                                        <div class="content" style="display: none;">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <ul class="row-list">
